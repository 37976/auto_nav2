...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'amcl_initial_localizer = nav_slam.amcl_initial_localizer:main',
            'icp_global_localizer = nav_slam.icp_global_localizer:main',
            ...
            'nav_experiment_logger = nav_slam.nav_experiment_logger:main',
            'nav_experiment_goal_runner = nav_slam.nav_experiment_goal_runner:main',
