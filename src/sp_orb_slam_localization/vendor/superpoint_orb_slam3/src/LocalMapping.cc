...
void LocalMapping::Run()
{
    ...
    while(1)
    {
        ...
        if(CheckNewKeyFrames() && !mbBadImu)
        {
            ...
            cout << "[LM] ProcessNewKeyFrame begin" << endl;
            ProcessNewKeyFrame();
            cout << "[LM] ProcessNewKeyFrame end" << endl;
#ifdef REGISTER_TIMES
            ...
            cout << "[LM] CreateNewMapPoints begin" << endl;
            CreateNewMapPoints();
            cout << "[LM] CreateNewMapPoints end" << endl;
            ...
            mbAbortBA = false;
                ...
                if(!CheckNewKeyFrames())
                {
                    ...
                    cout << "[LM] SearchInNeighbors begin" << endl;
                    SearchInNeighbors();
                    cout << "[LM] SearchInNeighbors end" << endl;
                }
            ...
            if(!CheckNewKeyFrames() && !stopRequested())
            {
                if(mpAtlas->KeyFramesInMap()>2)
                {
                    ...
                    {
                        cout << "[LM] LocalBundleAdjustment begin" << endl;
                ...
                KeyFrameCulling();
                cout << "[LM] KeyFrameCulling end" << endl;
...
void LocalMapping::ProcessNewKeyFrame()
{
    ...
    if(mpCurrentKeyFrame->mDescriptors.type() == CV_8U)
...
void LocalMapping::CreateNewMapPoints()
{
    ...
    SuperPointMatcher matcher(th,false);
