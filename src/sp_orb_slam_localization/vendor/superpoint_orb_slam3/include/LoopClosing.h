...
public:
    ...
    LoopClosing(Atlas*, KeyFrameDatabase*, ORBVocabulary*, const bool, const bool)
        : mpViewer(nullptr) {}

    void SetTracker(Tracking*) {}
    void SetLocalMapper(LocalMapping*) {}
    void Run() {}
    void InsertKeyFrame(KeyFrame*) {}
    void RequestReset() {}
    void RequestResetActiveMap(Map*) {}
    void RunGlobalBundleAdjustment(Map*, unsigned long) {}
    bool isRunningGBA() { return false; }
    bool isFinishedGBA() { return true; }
    void RequestFinish() {}
