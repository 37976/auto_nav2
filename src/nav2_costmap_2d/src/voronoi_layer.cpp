// This file has been superseded by plugins/voronoi_layer.cpp (ROS2 Humble).
// It is kept here only as a reference and is NOT compiled into any target.
// See plugins/voronoi_layer.cpp for the active ROS2 implementation.
